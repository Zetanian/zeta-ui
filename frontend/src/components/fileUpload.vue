...
<template>
  <div
    ref="dropZoneRef"
    class="flex cursor-pointer flex-col items-center justify-center rounded-lg border border-dashed p-6 transition-all hover:bg-gray-50"
  ...
  >
    ...
    <div class="text-center">
      ...
      <p class="mt-2 text-xs text-gray-400">(Max size: 500KB)</p>
    </div>
    ...
    <div v-if="file" class="mt-4 text-sm text-green-600">
